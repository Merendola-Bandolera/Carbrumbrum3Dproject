...
bool ModuleSceneIntro::Start()
{
	...
	addCube({ 58,	140 +200, 1652 }, { 2, 150, 120 }, Grey, 0, 0, 0);
	//monedas
	...
	addCube({ -683,	22 + 200, 790 }, { 2, 20, 100 }, Grey, 0, -45, 0);
	addCube({ -683,	22 + 200, 717 }, { 2, 20, 100 }, Grey, 0, 45, 0);
	addCube({ -593,	22 + 200, 710 }, { 2, 20, 500 }, Grey, 0, 0, 0);
	addCube({ -713,	22 + 200, 710 }, { 2, 20, 500 }, Grey, 0, 0, 0);
	addCube({ -683,	22 + 200, 790 -150 }, { 2, 20, 100 }, Grey, 0, -45, 0);
	addCube({ -683,	22 + 200, 717 -150 }, { 2, 20, 100 }, Grey, 0, 45, 0);
	addCube({ -683 +60,	22 + 200, 717 - 75 }, { 2, 20, 100 }, Grey, 0, -45, 0);
	addCube({ -683 +60,	22 + 200, 790 - 75 }, { 2, 20, 100 }, Grey, 0, 45, 0);
	addCube({ -683 + 60,	22 + 200, 717 - 225 }, { 2, 20, 100 }, Grey, 0, -45, 0);
	addCube({ -683 + 60,	22 + 200, 790 - 225 }, { 2, 20, 100 }, Grey, 0, 45, 0);
	...
	addCube({ -653,		 39 +200, 150 }, { 120, 20, 500 }, Grey, 0, 0, 0);			
			addCube({ -683,	42 + 200, 790 -550 }, { 2, 20, 100 }, Grey, 0, -45, 0);
			addCube({ -683,	42 + 200, 717- 550 }, { 2, 20, 100 }, Grey, 0, 45, 0);
			addCube({ -593,	42 + 200, 710- 550 }, { 2, 20, 500 }, Grey, 0, 0, 0);
			addCube({ -713,	42 + 200, 710- 550 }, { 2, 20, 500 }, Grey, 0, 0, 0);
			addCube({ -683,	42 + 200, 790 - 700 }, { 2, 20, 100 }, Grey, 0, -45, 0);
			addCube({ -683,	42 + 200, 717 - 700 }, { 2, 20, 100 }, Grey, 0, 45, 0);
			addCube({ -683 + 60,42 + 200, 717 - 625 }, { 2, 20, 100 }, Grey, 0, -45, 0);
			addCube({ -683 + 60,42 + 200, 790 - 625 }, { 2, 20, 100 }, Grey, 0, 45, 0);
			addCube({ -683 + 60,42 + 200, 717 - 775 }, { 2, 20, 100 }, Grey, 0, -45, 0);
			addCube({ -683 + 60,42 + 200, 790 - 775 }, { 2, 20, 100 }, Grey, 0, 45, 0);
