...
bool ModuleSceneIntro::Start()
{
	...
	addCube({ 100, -0.5f +200, 580 }, { 200, 2, 30 }, Grey, 0, -30, 0);
	addCube({ 279, -0.5f +200, 628 }, { 200, 2, 30 }, Grey, 0, 0, 0);
	addCube({ 190, -0.5f +200, 636 }, { 50, 2, 10 }, Grey, 0, 0, 10);	//rampa
	addCube({ 185, -0.5f +200, 636 }, { 50, 2, 10 }, Grey, 0, 0, 3);		//rampa
	addCube({ 360, -0.5f +200, 618 }, { 50, 2, 10 }, Grey, 0, 0, 10);//rampa
	addCube({ 355, -0.5f +200, 618 }, { 50, 2, 10 }, Grey, 0, 0, 3);	//rampa
	...
	addCoin({ 613, 3+200, 610 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCube({ 694, -0.5f+200, 657 }, { 100, 2, 30 }, Grey, 0, -40, 0);
	addCube({ 754, -0.5f+200, 728 }, { 100, 2, 30 }, Grey, 0, -60, 0);
	addCheckpoint({ 786, 2+200, 816 }, { 2, 2, 2 }, Yellow, 0, 0, 0);
	addCube({ 786, -0.5f+200, 816 }, { 100, 2, 30 }, Grey, 0, -80, 0);
	addCoin({ 816, 7+200, 900 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCube({ 807, -0.5f+200, 900 }, { 30, 2, 100 }, Grey, 0, 0, 30);	//Wallride
	addCube({ 817, 4+200, 1000 }, { 30, 2, 100 }, Grey, 0, 0, 60);		//Wallride
	addCube({ 800, 4+200, 1110 }, { 30, 2, 100 }, Grey, 0, -10, 0);
	addCube({ 819, 4+200, 1085 }, { 2, 30, 30 }, Grey, 0, -15, 0);


	//CURVA DE IVO
	addCube({ 1.7f + 782, 4 +200, 195 + 1009 }, { 30, 2, 100 }, Grey, 0, -10, 0);
	addCoin({ 1.7f + 782, 7 +200, 195 + 1009 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCube({ -24 + 782,  4 +200, 288 + 1009 }, { 30, 2, 100 }, Grey, 0, -20, 0);
	addCube({ -64.8 + 782,4 +200, 375 + 1009 }, { 30, 2, 100 }, Grey, 0, -30, 0);
	addCube({ -120 + 782, 4 +200, 453 + 1009 }, { 30, 2, 100 }, Grey, 0, -40, 0);
	addCoin({ -120 + 782, 7 +200, 453 + 1009 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCube({ -188 + 782, 4 +200, 520 + 1009 }, { 30, 2, 100 }, Grey, 0, -50, 0);
	addCube({ -262 + 782, 4 +200, 570 + 1009 }, { 30, 2, 100 }, Grey, 0, -60, 0);
	addCube({ -350 + 782, 4 +200, 610 + 1009 }, { 30, 2, 100 }, Grey, 0, -70, 0);
	addCoin({ -350 + 782, 7 +200, 610 + 1009 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCube({ -443 + 782, 4 +200, 635 + 1009 }, { 30, 2, 100 }, Grey, 0, -80, 0);
	addCube({ -539 + 782, 4 +200, 643 + 1009 }, { 30, 2, 100 }, Grey, 0, -90, 0);
	addCheckpoint({ 340, 6 +200, 643 + 1000 }, { 2, 2, 2 }, Yellow, 0, 0, 0);

	//ZONA DEL BARRO
	addCube({ 244,	13 +200, 1652 }, { 100, 2, 30 }, Grey, 0, 0, -10);
	addCube({ 149,	38 +200, 1652 }, { 100, 2, 30 }, Grey, 0, 0, -20);
	addCube({ -148,	55 +200, 1652 }, { 500, 2, 120 }, Grey, 0, 0, 0);
	//barros	
	...
	addCube({ 58,	150 +200, 1652 }, { 2, 150, 120 }, Grey, 0, 0, 0);
	//monedas
	addCoin({ -148 + 180, 58 +200, 1652 + 40 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 + 140, 58 +200, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 + 100, 58 +200, 1652 - 40 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 + 50,  58 +200, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 ,	  58 +200, 1652 + 40 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 - 50 , 58 +200, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 - 100 ,58 +200, 1652 - 40 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 - 140 ,58 +200, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 - 180 ,58 +200, 1652 + 40 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 - 220 ,58 +200, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 - 300 ,58 +200, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	//out of barro
	addCube({ -448,	55 +200, 1652 }, { 100, 2, 30 }, Grey, 0, 0, 0);
	addCheckpoint({ -468,	57 +200, 1652 }, { 2, 2, 2 }, Yellow, 0, 0, 0);
	addCube({ -534,	55+200, 1629 }, { 100, 2, 30 }, Grey, 0, -30, 0);
	addCube({ -597,	55+200, 1566 }, { 100, 2, 30 }, Grey, 0, -60, 0);
	addCube({ -627 ,55+200, 1486 }, { 30, 2, 100 }, Grey, 0, 0, -40); //Wallride
	addCube({ -653 ,79+200, 1486 }, { 30, 2, 100 }, Grey, 0, 0, -60); //Wallride
	addCube({ -653,	45+200, 1300 }, { 30, 2, 300 }, Grey, -10, 0, 0);
	addCoin({ -653,	48+200, 1300 }, { 5, 5, 5 }, Yellow, 0, 0, 30);


	//HIELO 1 + SETA 1
	addCube({ -653,			19 +200, 1010 }, { 30, 2, 300 }, Grey, 0, 0, 0);
	...
	addCoin({ -653 +50,		32 +200, 800 -40 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -653 ,		32 +200, 800 - 80 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -653 -50,		32 +200, 800 - 120 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -653 ,		32 +200, 800 - 160 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -653 + 50,	32 +200, 800 - 200 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -653,			32 +200, 800 - 240 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -653 - 50,	32 +200, 800 - 280 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -653,			32 +200, 800 - 320 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCube({ -653,			69 +200, 810 }, { 120, 2, 500 }, Grey, 0, 0, 0);

	//SETA 2
	addCube({ -653,		19 +200, 430 }, { 30, 20, 60 }, Grey, 0, 0, 0);
	addCoin({ -653,		32 +200, 480 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addBoosterUp({ -653,29 +200, 460 }, { 5, 5, 5 }, Orange, 0, 0, 0);


	//HIELO 2 + TUNEL
	addCube({ -653,		 39 +200, 150 }, { 120, 20, 500 }, Grey, 0, 0, 0);
	addCoin({ -653,		 32 +200, 800 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	...
	addCube({ -653,		 89 +200, 250 }, { 120, 2, 500 }, Grey, 0, 0, 0);
	addCube({ -653,		 10 +200, -133 }, { 30, 2, 100 }, Grey, -50, 0, 0);
	addCube({ -653 - 15, 25 +200, -143 }, { 2, 60, 70 }, Blue, 0, 0, 0);
	addCube({ -653 + 15, 25 +200, -143 }, { 2, 60, 70 }, Blue, 0, 0, 0);
	addCheckpoint({ -653,52 +200, -83 }, { 2, 2, 2 }, Yellow, 0, 0, 0);
	addCube({ -653,		 45 +200, -123 }, { 30, 2, 30 }, Grey, -40, 0, 0);
	addCube({ -653,		  8 +200, -143 }, { 30, 2, 100 }, Grey, -30, 0, 0);
	addCube({ -653,		  5 +200, -153 }, { 30, 2, 100 }, Grey, -10, 0, 0);
	addCube({ -653,		-0.5f +200, -203 }, { 30, 2, 100 }, Grey, 0, 0, 0);
	addCube({ -653,		-0.5f +200, -368 }, { 30, 2, 230 }, Grey, 0, 0, 0);

	//WALLRIDE
	addCube({ -647 - 15,-0.5f +200, -353 }, { 50, 2, 300 }, Grey, 0, 0, -20);
	addCoin({ -652,		   10 +200, -353 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCube({ -647 - 25,-0.5f +200, -353 }, { 50, 2, 300 }, Grey, 0, 0, -40);
	addCube({ -647 - 63,-0.5f +200, -353 }, { 50, 50, 300 }, Grey, 0, 0, 0);
	addCube({ -647 - 35,-0.5f +200, -483 }, { 2, 50, 50 }, Grey, 0, -10, 0);
	addCube({ -647 - 30,-0.5f +200, -493 }, { 2, 50, 50 }, Grey, 0, -20, 0);
	addCube({ -647 - 25,-0.5f +200, -503 }, { 2, 50, 50 }, Grey, 0, -40, 0);
	addCube({ -647 - 20,-0.5f +200, -513 }, { 2, 50, 50 }, Grey, 0, -60, 0);
	addCube({ -647 - 10,-0.5f +200, -523 }, { 2, 50, 50 }, Grey, 0, -80, 0);
	addCube({ -640 ,	-0.5f +200, -551 }, { 400, 50, 50 }, Grey, 0, 0, 0);
	addCube({ -587 ,	-0.5f +200, -513 }, { 200, 2, 50 }, Grey, 50, 0, 0);
	addCube({ -493,		-0.5f +200, -498 }, { 400, 2, 30 }, Grey, 0, 0, 0);

	//ZONA BOCARRIBA		  
	addCheckpoint({ -460 ,	  3+200, -500 }, { 2, 2, 2 }, Yellow, 0, 0, 0);
	addCube({ -393,			 20+200, -408 }, { 60, 2, 300 }, Grey, 0, 0, 0);
	addCube({ -363,			 20+200, -498 }, { 2, 50, 30 }, Grey, 0, 0, 0);
	...
	addCube({ -393,		-0.5f +200, -275 }, { 50, 2, 75 }, Grey, 0, 0, 0);
	addCheckpoint({ -393,	3 +200, -275 }, { 2, 2, 2 }, Yellow, 0, 0, 0);
	addCube({ -258 - 75,-0.5f +200, -475 + 250 }, { 100, 2, 30 }, Grey, 0, -30, 0);
	addCube({ -196 - 75,-0.5f +200, -412 + 250 }, { 100, 2, 30 }, Grey, 0, -60, 0);
	addCube({ -173 - 75,-0.5f +200, -327 + 250 }, { 100, 2, 30 }, Grey, 0, -90, 0);
	addCube({ -173 - 65,-0.5f +200, -15 }, { 50, 2, 30 }, Grey, 0, -60, 0);
	addCube({ -173 - 36,-0.5f +200, 12 }, { 50, 2, 30 }, Grey, 0, -30, 0);

	//ULTIMA CURVA
	addCube({ -50,-0.5f+ 200, 10 }, { 300, 2, 30 }, Grey, 30, 0, 0);
	addCube({ -50,-0.5f+ 200, -18 }, { 200, 50, 30 }, Grey, 0, 0, 0);
	addCube({ 24 ,-0.5f+ 200,38 - 12 }, { 2, 50, 100 }, Grey, 0, 20, 0);
	addCube({ 24 ,-0.5f+ 200,34 - 12 }, { 2, 50, 100 }, Grey, 0, 30, 0);
	addCube({ 24 ,-0.5f+ 200,30 - 12 }, { 2, 50, 100 }, Grey, 0, 40, 0);
	addCube({ 24 ,-0.5f+ 200,26 - 12 }, { 2, 50, 100 }, Grey, 0, 50, 0);
	addCube({ 24 ,-0.5f+ 200,22 - 12 }, { 2, 50, 100 }, Grey, 0, 60, 0);
	addCube({ 24 ,-0.5f+ 200,18 - 12 }, { 2, 50, 100 }, Grey, 0, 70, 0);
	addCube({ 24 ,-0.5f+ 200,14 - 12 }, { 2, 50, 100 }, Grey, 0, 80, 0);
	addCube({ 24 ,-0.5f+ 200,10 - 14 }, { 2, 50, 100 }, Grey, 0, 90, 0);
	addCube({ 20 ,   -5+ 200, 50 }, { 2, 75, 100 }, Grey, 0, 0, -30);
