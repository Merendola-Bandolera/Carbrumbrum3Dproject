...
bool ModuleSceneIntro::Start()
{
	...
	addCoin({ -148, 58, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148 -50, 58, 1652 +40 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148, 58, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	addCoin({ -148, 58, 1652 }, { 5, 5, 5 }, Yellow, 0, 0, 30);
	...
	addCube({ -647 - 38,-0.5f, -353 }, { 2, 50, 300 }, Grey, 0, 0, 0);  	
	...
	//ZONA BOCARRIBA
	addCube({ -393,	20, -498 }, { 100, 2, 60 }, Grey, 0, 0, 0);     	
	addCube({ -393 ,10, -528 }, { 100, 50, 2 }, Grey, 0, 0, 0);			
	addCube({ -393 ,10, -528 +60 }, { 100, 50, 2 }, Grey, 0, 0, 0);		
	addGravityChanger({ -438,1, -498 }, { 2, 10, 60 }, Blue, 0, 0, 0);
	addGravityChanger({ -345,20, -498 }, { 2, 10, 60 }, Blue, 0, 0, 0);
	

	addCube({ -258,	-0.5f, -475 }, { 100, 2, 30 }, Grey, 0, -30, 0);
